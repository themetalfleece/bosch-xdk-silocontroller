...
#define PIPE_OBJECT_INDEX_VALUE                   INT32_C(1)        /**< Macro used to define the object index*/
#define PIPE_OBJECT_INSTANCE_INDEX_VALUE          INT32_C(1)        /**< Macro used to define object Instance number*/
#define OWNER_OBJECT_RESOURCE_NUMBER               INT32_C(0)       /**< Macro used to define the resource number*/
