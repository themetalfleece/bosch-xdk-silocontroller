...
export BCDS_APP_NAME = Lwm2mExampleClient
...
export BCDS_XDK_APP_SOURCE_FILES = \
	...
	$(BCDS_APP_SOURCE_DIR)/Lwm2mObjects.c \
	$(BCDS_APP_SOURCE_DIR)/Lwm2mObjectsDevice.c \
	$(BCDS_APP_SOURCE_DIR)/Lwm2mExampleClient.c \
